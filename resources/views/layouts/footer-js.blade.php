...
<!--Scroll to top  --{{URL::asset('assets/')}} -->
...
<script src="{{URL::asset('assets/js/jquery.paroller.min.js')}}"></script>
<script src="{{URL::asset('assets/js/owl.js')}}"></script>
<script src="{{URL::asset('assets/js/wow.js')}}"></script>
<script src="{{URL::asset('assets/js/nav-tool.js')}}"></script>
...
<script src="{{URL::asset('assets/js/color-settings.js')}}"></script>
